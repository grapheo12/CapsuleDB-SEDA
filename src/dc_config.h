...
#define DEBUG_MODE true // verbose logs
...
#define CLIENT_ID (ConfigMap::GetConfig()->dc_client_id)
...
#define NET_PAIRING_DC_SERVER_IPs ((ConfigMap::GetConfig()->dc_server_addr) + ":1") // comma-separated "pairing peer IP:server count there" (e.g. 128.32.37.26:3,128.32.37.46:2)
...
// Global Config
#define VERIFY_SIG_PER_WRITES 1
#define WRITE_THRESHOLD 1
